...
ui_win[["Plot"]] <- fluidPage(
  ...
  div(HTML('<div class="logo"><img src="static/mfn.png" width="100%"><br/><b>Programmierung:</b><br/>Johan Renaudie<br/>
  <img src="static/MFN_gross_gruen.jpg" width="100%"><br/><b>Design:</b><br/>David Ware</div>'))
)
